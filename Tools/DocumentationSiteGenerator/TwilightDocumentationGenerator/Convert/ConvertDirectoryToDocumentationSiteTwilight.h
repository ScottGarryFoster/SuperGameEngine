#pragma once
#include "ConvertDirectoryToDocumentationSite.h"
...
namespace TwilightDocumentationGenerator
{
    ...
    /// </summary>
    class ConvertDirectoryToDocumentationSiteTwilight : public ConvertDirectoryToDocumentationSite
    {
        ...
        virtual ConversionResult ConvertDirectory(const std::string& source, const std::string& destination) override;
    };
}
