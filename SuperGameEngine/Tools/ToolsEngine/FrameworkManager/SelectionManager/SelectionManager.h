...
namespace SuperGameTools
{
    ...
    public:
        ...
        virtual void AddToSelection(const std::vector<std::weak_ptr<Selectable>>& selectable) = 0;
        ...
        /// </summary>
        /// <param name="selectable">New selections. </param>
        virtual void SetSelection(const std::vector<std::weak_ptr<Selectable>>& selectable) = 0;

        /// <summary>
        /// Remove selectable from selections.
        /// </summary>
        /// <param name="selectable">Removable selections. </param>
        virtual void RemoveFromSelection(const std::vector<std::weak_ptr<Selectable>>& selectable) = 0;
