...
namespace SuperGameTools
{
    ...
    /// </summary>
    class LayoutEditorTextInputArray : public virtual LayoutEditor, LayoutEditorArray
    {
    public:
        /// <summary>
        /// Constructor.
        ...
        LayoutEditorTextInputArray(const std::string& map, const std::shared_ptr<LayoutRequirements>& layoutRequirements);
        virtual ~LayoutEditorTextInputArray();
