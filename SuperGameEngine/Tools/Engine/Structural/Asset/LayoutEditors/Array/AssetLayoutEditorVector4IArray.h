...
namespace SuperGameTools
{
    ...
    /// </summary>
    class AssetLayoutEditorVector4IArray : public virtual AssetLayoutEditor, AssetLayoutEditorArray
    {
    public:
        /// <summary>
        /// Constructor.
        ...
        AssetLayoutEditorVector4IArray(const std::string& map);
        virtual ~AssetLayoutEditorVector4IArray();
