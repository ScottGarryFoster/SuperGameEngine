...
namespace SuperGameTools
{
    ...
    /// </summary>
    class OnMenuAddComponentEventArguments : public FEventArguments
    {
    public:
        OnMenuAddComponentEventArguments(
        ...
        /// <summary>
        /// The ID of the Tree view item requested to add.
        /// </summary>
        ...
        /// <summary>
        /// The Component requested for add.
        /// </summary>
        /// <returns>The Game Object requested to add. </returns>
