...
python ../FatedQuest.Libraries/CMake/RepathSolutionFile.py build\SuperGameEngine-Tools.sln SuperGameEngine.sln --prefix build
python ../FatedQuest.Libraries/CMake/CreateShortcut.py Generate-Tools.bat Regenerate
