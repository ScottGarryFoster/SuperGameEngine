...
#pragma region Int
        ...
        /// <param name="defaultValue">Value which is default in the class anyway. </param>
        /// <returns>A document node representing the property. </returns>
        virtual std::shared_ptr<FatedQuestLibraries::ModifiableNode> Serialize(const std::string& name, int value, int defaultValue) const = 0;
        ...
        /// <param name="parentOfProperties">Parent of the property. </param>
        /// <returns>The parsed value of the property or the default. </returns>
        virtual int ParseFromParent(const std::string& name, int defaultValue, const std::shared_ptr<FatedQuestLibraries::StoredDocumentNode>& parentOfProperties) const = 0;
        ...
        /// <param name="data">Node containing the data. </param>
        /// <returns>The parsed value of the property or the default. </returns>
        virtual int Parse(int defaultValue, const std::shared_ptr<FatedQuestLibraries::StoredDocumentNode>& data) const = 0;
#pragma endregion
