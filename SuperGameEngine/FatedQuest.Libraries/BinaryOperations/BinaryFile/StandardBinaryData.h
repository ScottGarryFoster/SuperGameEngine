...
namespace BinaryOperations
{
    ...
    /// </summary>
    class StandardBinaryData : public BinaryData
    {
    public:
        StandardBinaryData();
        virtual ~StandardBinaryData();
        ...
        /// and writing process.
        /// </summary>
        /// <param name="key">What to call this int. </param>
        ...
        /// This must be a unique name for this int.</param>
        virtual void AddString(std::string key) override;
        ...
        /// <param name="value">New value to set. </param>
        virtual void SetString(std::string key, std::string value) override;
        ...
        virtual std::string TryGetString(std::string key, std::string defaultValue) override;
    ...
    private:
        ...
        /// <summary>
        /// Indicates if an string value is set or not.
        /// </summary>
        struct StringValue
        {
        public:
        ...
        /// <summary>
        /// Holds the String values for the Binary Operations.
        /// </summary>
        std::map<std::string, StringValue> m_stringValues;
        ...
        /// <summary>
        /// Take the binary data and load the string key from it.
        /// Must start at the point the int keys begin.
        /// </summary>
        /// <param name="stringStream">String stream seeked to the string keys. </param>
        /// <returns>Current seeked string. </returns>
        std::string ProcessStringKeys(std::shared_ptr<FStringStream> stringStream);
    };
}