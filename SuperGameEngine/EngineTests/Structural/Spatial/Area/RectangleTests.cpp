...
#pragma region CloestPointTo
    TEST_F(RectangleTests, CloestPointTo_MatchesY_WhenToTheLeftOrRight)
    {
        ...
        // Act
        FVector2D actualLeft = m_testRectangle->ClosestPointTo(givenLocationLeft);
        FVector2D actualRight = m_testRectangle->ClosestPointTo(givenLocationRight);
    ...
    TEST_F(RectangleTests, CloestPointTo_MatchesX_WhenAboveOrBelow)
    {
        ...
        // Act
        FVector2D actualAbove = m_testRectangle->ClosestPointTo(givenLocationAbove);
        FVector2D actualBelow = m_testRectangle->ClosestPointTo(givenLocationBelow);
    ...
    TEST_F(RectangleTests, CloestPointTo_MatchesYBelow_WhenBelow)
    {
        ...
        // Act
        FVector2D actualBelow = m_testRectangle->ClosestPointTo(givenLocationRight);
