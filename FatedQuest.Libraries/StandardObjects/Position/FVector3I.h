...
namespace FatedQuestLibraries
{
    ...
    public:
        ...
        virtual void SetXYValue(const FVector3I& other);
        ...
        FVector3I operator+(const FVector3I& other) const;
        ...
        FVector3I operator*(int scalar) const;
        ...
        [[nodiscard]] FVector3I Normalize() const;
        ...
        [[nodiscard]] int DotProduct(const FVector3I& other) const;
        ...
        [[nodiscard]] float DistanceBetween(const FVector3I& other) const;
